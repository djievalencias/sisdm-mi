...
@section('content')
    <x-page :title="__('Edit Job History') . ' — ' . $user->nama" :breadcrumb="__('Job History')">
        <div class="card">
                        ...
                        <select name="id_jabatan" id="jabatan" class="form-control @error('id_jabatan') is-invalid @enderror" required>
                            ...
                            @foreach ($jabatanList as $jabatan)
                                <option value="{{ $jabatan->id }}"
                                    ...
                                    {{ old('id_jabatan', $riwayatJabatan->id_jabatan) == $jabatan->id ? 'selected' : '' }}>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" name="tanggal_mulai" id="tanggal_mulai" class="form-control @error('tanggal_mulai') is-invalid @enderror"
                                value="{{ old('tanggal_mulai', $riwayatJabatan->tanggal_mulai) }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" name="tanggal_selesai" id="tanggal_selesai" class="form-control @error('tanggal_selesai') is-invalid @enderror"
                                value="{{ old('tanggal_selesai', $riwayatJabatan->tanggal_selesai) }}">
    ...
    <script>
        ...
        document.getElementById('jabatan').addEventListener('change', syncJabatanFields);
        window.addEventListener('load', syncJabatanFields);
    </script>
@endsection
